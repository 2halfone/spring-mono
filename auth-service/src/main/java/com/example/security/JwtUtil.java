 ...
 * Handles token generation (auth-service only) and validation (all services).
 * 
 * Security Features:
...
public class JwtUtil {
     ...
     * 
     * @return SecretKey for JWT signing/validation
     ...
     * ONLY to be used by auth-service for login/refresh operations.
     * 
    ...
    /**
     * Generates a simple JWT token with username only.
     * 
     * @param username User's username
     * @return Generated JWT token
     */
    public String generateToken(String username) {
        return generateToken(username, "USER", null);
    }
